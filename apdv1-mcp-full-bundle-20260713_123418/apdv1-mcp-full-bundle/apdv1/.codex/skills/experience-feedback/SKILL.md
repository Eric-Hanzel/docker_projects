...
- success: local-run deployment or portable final bundle finished and verification passed
...
- `DP_LOGS/<project_name>-final/deploy.log` if portable final bundle ran
