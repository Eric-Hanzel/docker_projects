...
- ### glances-final.tar.gz
    {"url":"https://github.com/nicolargo/glances"}
- ### nextcloud-final.tar.gz
    {"url":"https://github.com/nextcloud/server"}
- ### owncloud-final.tar.gz
    {"url":"https://github.com/owncloud/core"}
- ### filebrowser-final.tar.gz
    {"url":"https://github.com/filebrowser/filebrowser"}
- ### minio-final.tar.gz
    {"url":"https://github.com/minio/minio"}
- ### seaweedfs-final.tar.gz
    {"url":"https://github.com/seaweedfs/seaweedfs"}
- ### kubo-final.tar.gz
    {"url":"https://github.com/ipfs/kubo"}
- ### syncthing-final.tar.gz
    {"url":"https://github.com/syncthing/syncthing"}
- ### helm-final.tar.gz
     {"url":"https://github.com/helm/helm"}
- ### kapitan-final.tar.gz
    {"url":"https://github.com/kapicorp/kapitan"}
- ### keel-final.tar.gz
    {"url":"https://github.com/keel-hq/keel"}
- ### kapp-final.tar.gz
    {"url":"https://github.com/vmware-tanzu/carvel-kapp"}
- ### dagger-final.tar.gz
    {"url":"https://github.com/dagger/dagger"}
- ### earthly-final.tar.gz
    {"url":"https://github.com/earthly/earthly"}
- ### fluent-bit-final.tar.gz
    {"url":"https://github.com/fluent/fluent-bit"}
- ### logstash-final.tar.gz
...
- ### exim
    {"url":"https://github.com/Exim/exim"}
- ### joomla
...
### v0.0.1
- ### octobercms
    {"url":"https://docs.octobercms.com/4.x/setup/installation.html#minimum-system-requirements"}
